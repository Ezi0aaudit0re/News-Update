 ...
 ! ------------- Features Implemeted my me --------!
 
 1.) Import database using command line program coded in PHP (!#)
 2.) Ajax call to get articles from a PHP page
 3.) Implement the search for postal_adresses from the database
 4.) Resposive collapsing div's using Bootstrap 
 5.) Implementation of Markers using Google API 
 6.) Breaking news of a country in a div 
